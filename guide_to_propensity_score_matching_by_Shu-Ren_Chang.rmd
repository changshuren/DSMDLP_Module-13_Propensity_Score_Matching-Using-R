...
*load dataset*
```{r, echo=FALSE}
load(file="U:/U-Shu-Ren/Mine/Data_Certificate/DSMDLP Training Fall 2024/Module_13/Chapter5_data_breastfeeding_example.rData")
...
length(rownames(covariate.balance[[1]])[(abs(covariate.balance[[1]][,3]) > 0.25)])
```
